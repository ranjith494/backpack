...
public class LaunchECSCloudFormationStack {
	
public static AWSCredentials credentials;
private static AmazonCloudFormation stackbuilder;
private static String stackName="MyECSStack";
...
public static AWSCredentials loadCredentials() {
	...
	public LaunchECSCloudFormationStack() {

	}
	
	
	public LaunchECSCloudFormationStack(AmazonCloudFormation stackbuilder) {
    ...
    try {
        ...
        createRequest.setTemplateBody(convertStreamToString(LaunchECSCloudFormationStack.class.getClassLoader().getResourceAsStream("cloudformationtemplate.json")));
...
public void createStack(String input) throws Exception{
	CreateStackRequest createRequest = new CreateStackRequest();
    createRequest.setStackName(stackName);
    createRequest.withCapabilities("CAPABILITY_IAM");
    createRequest.setTemplateBody(input);
    System.out.println("Creating a stack called " + createRequest.getStackName() + ".");
    stackbuilder.createStack(createRequest);
